...
public class InteractableObject : MonoBehaviour
{
    ...
    {
        // Belirlediğimiz yarıçap içindeki tüm objeleri tarar
        Collider[] hitColliders = Physics.OverlapSphere(transform.position, hearingRadius);
        
        foreach (Collider hitCollider in hitColliders)
        {
            // Çarptığımız alanın içindeki objede FreshmanAI scripti var mı?
            ...
            if (npc != null)
            {
                ...
                // Öğrenciyi bulduğumuz için döngüyü kırabiliriz
                break; 
            }
        }
    }
